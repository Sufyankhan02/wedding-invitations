        ...
        <section id="home" className="min-h-screen flex flex-col items-center justify-center px-4 py-16 sm:py-20 text-center relative overflow-hidden">
            ...
            >
                ...
                <div className="space-y-4">
                    ...
                    >
                        In Sha Allah, We Will Get Married
                    </motion.p>
                ...
                >
                    ...
                    {/* ✅ ONLY CHANGE IS SHADOW HERE */}
                    <div className="relative px-4 sm:px-8 py-8 sm:py-10 rounded-2xl border border-rose-100/50 shadow-lg shadow-rose-200/40">
